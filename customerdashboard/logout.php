          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-10 py-10">
                <center><h3 class="card-title text-left mb-12">Logout Here</h3></center>
                <form>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  <a href="index.php?accountno=<?php echo $account?>&email=<?php echo $email?>"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancle</button></a>
