        ...
        <div class="main-panel">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        <a class="btn btn-danger" href="Payment/withd.php?accountno=<?php echo $account;?>&email=<?php echo $email;?>" role="button" >-Withdraw</a>
                        <a class="btn btn-success" href="Payment/dep.php?accountno=<?php echo $account;?>&email=<?php echo $email;?>" role="button">+Deposite</a>
                      </div>
                    </dv>
                  </div>
                </div>
                      ...
                      <table class="table">
                        <thead>
                          <?php
                              ...
                              $query = "select Balance,WD,Date from balance_info where AccountNo = $account ";
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyrights © 2021 All Rights Reserved by <a href="#">Borse Vaishnavi and Team</a></span>
            </div>
          </footer>
          <!-- partial -->
        </div>
